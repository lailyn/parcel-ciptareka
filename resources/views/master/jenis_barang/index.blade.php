			...
			<div class="block">
				<div class="block-header block-header-default">
					<h3 class="block-title">
						<a class="btn btn-danger btn-sm float-right" href="{{ route('jenis_barang.insert') }}"> <i class="fa fa-plus"></i> Add Item</a>
					</h3>				
				</div>
								...
								<td>
								  <div class="dropdown">
									...
									<div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
										<a class="dropdown-item" href="{{ route('jenis_barang.edit', $row->id) }}">Edit</a> 
										<a class="dropdown-item" href="{{ route('jenis_barang.delete', $row->id) }}" onclick="return confirm('Yakin?')">Delete</a> 
									</div>
								</div>
								</td>
							  </tr>

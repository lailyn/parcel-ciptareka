								...
								<div class="flex-sm-00-auto mt-3 mt-sm-0 ml-sm-3">
									<span class="d-inline-block invisible" data-toggle="appear" data-timeout="350">
										<a class="btn btn-primary px-4 py-2" data-toggle="click-ripple" href="">
											<i class="fa fa-plus mr-1"></i> Setoran Baru
										</a>
									</span>
								</div>
							</div>
				...
				<div class="content content-narrow">
					...
					<div class="row">
						...
						<div class="col-6 col-md-3 col-lg-6 col-xl-3">
							<a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
								<div class="block-content block-content-full">
									<div class="font-size-sm font-w600 text-uppercase text-muted">Membership</div>
									<div class="font-size-h2 font-w400 text-dark"><?=DB::table("member")->get()->count();?></div>
								</div>
							</a>
						</div>
						<div class="col-6 col-md-3 col-lg-6 col-xl-3">
							<a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
								<div class="block-content block-content-full">
									...
									<div class="font-size-h2 font-w400 text-dark"><?=DB::table("partnership")->get()->count();?></div>
								</div>
							</a>
						</div>
						<div class="col-6 col-md-3 col-lg-6 col-xl-3">
							<a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
								<div class="block-content block-content-full">
									...
									<div class="font-size-h2 font-w400 text-dark"><?=DB::table("paket")->get()->count();?></div>
								</div>
							</a>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="block block-rounded block-mode-loading-oneui">
								<div class="block-header">
									<h3 class="block-title">Jumlah Setoran in Rp</h3>

		...
		<div class="content">
			...
			<div class="block">
				...
				<div class="block-content block-content-full">									
					<?php $row = $manifest; ?>					
					<form class="mb-5" action="{{ route('manifestAntar.updatePenerimaan',$row->id) }}" enctype="multipart/form-data" method="POST">										
						...
						<div class="form-group row">																														
							...
							<div class="col-sm-2">
								<select disabled class="form-control" id="karyawan_id" onchange="cekCakupan()" name="karyawan_id" required>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
											<a class="dropdown-item" href="{{ route('manifestAntar.barangDiterima', $row->pengiriman_id) }}">Diterima</a> 
											<a class="dropdown-item" href="{{ route('manifestAntar.barangTidakDiterima', $row->pengiriman_id) }}">Ditunda</a> 											
										</div>
									</div>
								</td>
							</tr>

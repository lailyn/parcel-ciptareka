		...
		<div class="content">
			...
			<div class="block">
				...
				<div class="block-content block-content-full">									
					<?php $row = $manifest; ?>					
					<form class="mb-5" action="{{ route('manifestJemput.update',$row->id) }}" enctype="multipart/form-data" method="POST">										
					        	...
					        	@foreach ($pengiriman as $key => $isi)
										...
										<tr>
											...
											<td class="text-center">
												<a href="{{ route('manifestJemput.addItem',[$isi->id,$row->code]) }}" class="btn btn-success btn-sm">
													pilih
												</a>
											</td>
										</tr>
					...
					<table class="table table-responsive table-bordered table-striped table-vcenter">
						...
						@foreach ($manifestDetail as $key => $row)
							...
							<tr>
								...
								<td class="text-center">
									<a href="{{ route('manifestJemput.deleteDetail', $row->ids) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure...?')">Delete</a>
								</td>
							</tr>
						@endforeach													
						</tbody>

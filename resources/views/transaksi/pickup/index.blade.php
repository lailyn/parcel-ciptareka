			...
			<div class="block">
				<div class="block-header block-header-default">
					<h3 class="block-title">
						<a class="btn btn-warning btn-sm float-right ml-2" href="{{ route('pickup.index') }}"> <i class="fa fa-history"></i> History</a>
						<a class="btn btn-danger btn-sm float-right" href="{{ route('pickup.insert') }}"> <i class="fa fa-plus"></i> Pickup Baru (Khusus Kurir)</a>
					</h3>
				</div>				

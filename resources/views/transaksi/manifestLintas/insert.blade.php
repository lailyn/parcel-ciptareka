			...
			<div class="block">
				<div class="block-header block-header-default">
					<h3 class="block-title">
						<a class="btn btn-warning btn-sm float-right" href="{{ route('manifestLintas.insert') }}"> <i class="fa fa-chevron-left"></i> Back</a>
					</h3>
				</div>
				<div class="block-content block-content-full">									
					<?php if($set!="generate"){ $rt = ""; ?>
						<form class="mb-5" action="{{ route('manifestLintas.generate') }}" enctype="multipart/form-data" method="POST">					
					<?php }else{ $rt = "readonly"; ?>
						<form class="mb-5" action="{{ route('manifestLintas.create') }}" enctype="multipart/form-data" method="POST">					
					<?php } ?>
                ...
                <select class="form-control select2" id="port_tujuan" name="port_tujuan" required>
						...
						<div class="form-group row">						
							...
							<div class="col-sm-4">
								...
								<a href="{{ route('manifestLintas.insert') }}" class="btn btn-secondary btn-sm"> Reset</a>
							</div>
							<?php } ?>
						</div>					
				</div>

		...
		<div class="content">
			...
			<div class="block">
				...
				<div class="block-content block-content-full">									
					<?php $row = $manifest; ?>					
					<form class="mb-5" action="{{ route('manifestLintas.updatePenerimaan',$row->id) }}" enctype="multipart/form-data" method="POST">										
							...
							<tr>
								...
								<td>
									<div class="custom-control custom-checkbox custom-control-danger custom-control-lg mb-1">																			
										...
										<input type="hidden" name="manifestLintas_detail_id_<?=$no;?>" value="<?=$row->ids;?>">											

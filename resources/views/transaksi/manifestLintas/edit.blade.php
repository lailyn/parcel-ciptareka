					        	...
					        	@foreach ($manifestMentah as $key => $isi)
										...
										<tr>
											...
											<td class="text-center">
												<a href="{{ route('manifestLintas.addItem',[$isi->id,$row->code]) }}" class="btn btn-success btn-sm">
													pilih
												</a>
											</td>
										</tr>
					...
					<table class="table table-responsive table-bordered table-striped table-vcenter">
						...
						@foreach ($manifestDetail as $key => $row)
							...
							<tr>
								...
								<td class="text-center">
									<a href="{{ route('manifestLintas.deleteDetail', $row->ids) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure...?')">Delete</a>
								</td>
							</tr>
						@endforeach													
						</tbody>
